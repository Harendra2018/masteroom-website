...
function init()
{
	...
	gui.close(); // Collapse the GUI panel at startup

	// Add controls icon to GUI title
	const titleElement = gui.domElement.querySelector('.title');
	if (titleElement) {
		titleElement.innerHTML = '<img src="textures/controls.svg" style="width:20px;height:20px;vertical-align:middle;">';
