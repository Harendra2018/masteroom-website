...
// AreaLight shader code
THREE.ShaderChunk[ 'AreaLight.glsl' ] = `
// AreaLight.glsl - Area light shader code

// Area light uniforms
uniform vec3 uAreaLightV0;
uniform vec3 uAreaLightV1;
uniform vec3 uAreaLightV2;
uniform vec3 uAreaLightV3;
uniform vec3 uAreaLightNormal;
uniform vec3 uAreaLightEmission;
...
/**
 * Initialize area light from uniforms
...
vec3 SampleAreaLight()
{
    ...
    randPointOnLight.z = mix(quads[0].v0.z, quads[0].v1.z, rng());
...
/**
 * Get area light emission
 */
vec3 GetAreaLightEmission()
{
    return quads[0].emission;
}

/**
 * Get area light normal
 */
vec3 GetAreaLightNormal()
{
    return quads[0].normal;
}
`;
