...
mainAreaLight.setPosition(-5, 25, 40);
mainAreaLight.setRotation(1.2,0,.2);
mainAreaLight.setScale(40,0,40);
mainAreaLight.setColor(0.6, 0.7, 1); // front
mainAreaLight.setIntensity(5.0);
areaLightManager.addLight(mainAreaLight);

// Add a second area light
let secondAreaLight = new AreaLight();
secondAreaLight.setPosition(30, 28, -40);
secondAreaLight.setRotation(-1.6,0,-1.2);
secondAreaLight.setScale(90,30,50);
secondAreaLight.setColor(0.5, .8, 1); // right
secondAreaLight.setIntensity(5);
areaLightManager.addLight(secondAreaLight);

// Add a third area light
let thirdAreaLight = new AreaLight();
thirdAreaLight.setPosition(0, 60, 0);
thirdAreaLight.setRotation(0,0,0);
thirdAreaLight.setScale(60,30,30);
thirdAreaLight.setColor(1, 0.7, 0.38); //top
thirdAreaLight.setIntensity(10.0);
...
function initSceneData() 
{
	...
	cameraControlsObject.position.set(60, 20, 60);
	// turn right
